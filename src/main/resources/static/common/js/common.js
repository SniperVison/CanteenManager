document.write("<script language=javascript src='static/plugins/jquery/jquery-3.3.1.min.js'></script>");
document.write("<script language=javascript src='static/plugins/jquery-validate/jquery.validate.min.js'></script>");
document.write("<script language=javascript src='static/plugins/jquery-validate/messages_zh.min.js'></script>");
document.write("<script language=javascript src='static/plugins/jquery-validate/additional-methods.min.js'></script>");
document.write("<script language=javascript src='static/plugins/sweetalert2/sweetalert2.js'></script>");
document.write("<link href='/static/plugins/font-awesome/css/font-awesome.min.css' rel='stylesheet'>")
